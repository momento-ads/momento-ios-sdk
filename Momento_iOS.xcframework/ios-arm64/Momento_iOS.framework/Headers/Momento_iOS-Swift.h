...
///
/// \param button 클릭 시 광고 페이지/앱스토어로 이동할 수 있도록 하는 UIButton을 <em>Non-Optional</em>로 받습니다.
///
/// \param optionalButton 기본 클릭 버튼 외에 커스텀한 버튼이 필요할 경우 광고 페이지로 연결해주는 UIButton을 Optional로 받습니다.
///
...
@interface MomentVideoManager : UIViewController
...
@interface MomentVideoManager (SWIFT_EXTENSION(Momento_iOS)) <WKNavigationDelegate>
